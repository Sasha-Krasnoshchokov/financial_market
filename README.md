...
## Bonus implementation
  - you can switch between updating intervals from drop down intervals filter;
  - you can switch on/off tickers from drop down tickers filter or from main page;
  - you can switch on/off updating tickers from main page;
  - add visual effects to highlight "positive" or "negative" prices
